...
const buttonVariants = cva(
   'inline-flex items-center justify-center capitalize gap-[0.75rem] leading-normal transition-all disabled:opacity-50 disabled:cursor-not-allowed font-semibold',
   {
      variants: {
         variant: {
            empty: '',
            default: 'text-white-950 bg-white-50 disabled:bg-white-50 focus:border-accent-600',
            secondary:
